...
import com.example.xiong.fragmenttest.IndicatorFragmentActivity.TabInfo;
...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    protected void onDraw(Canvas canvas) {
        ...
        path.rewind();
        float offset = 0;
        float left_x = mSelectedTab * mPerItemWidth + offset + scroll_x+20f;
        float right_x = (mSelectedTab + 1) * mPerItemWidth - offset + scroll_x-20f;
